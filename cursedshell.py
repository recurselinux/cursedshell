...
history_file = os.path.abspath(os.path.expanduser("~/.cursedshell_history"))
post_data = {}
cookies = {}
headers = {
        'User-Agent': '',
...
banner= "
                             _     _          _ _ 
                             | |   | |        | | |
  ___ _   _ _ __ ___  ___  __| |___| |__   ___| | |
 / __| | | | '__/ __|/ _ \/ _` / __| '_ \ / _ \ | |
| (__| |_| | |  \__ \  __/ (_| \__ \ | | |  __/ | |
 \___|\__,_|_|  |___/\___|\__,_|___/_| |_|\___|_|_|
...
sys.stdout.write("[*] cursedshell v" + version + "\n")
